...
▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰
 ...
 ▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰
 https://www.777bigwingame.org/#/register?invitationCode=34252129133
▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰
...
if (!freeModeEnabled && !allowedsixlotteryIds.has(gameUserId)) {
  await sendMessageWithRetry(ctx, 
    ...
    `${EMOJI.INFO} ခွင့်ပြုချက်တောင်းရန် @Minmanarpaylo သို့ ID ပို့ပေးပါ:\n` +
...
const BOT_TOKEN = "8014626740:AAGtUtphJnSihFTbw5LdYZQZ_n7_Zruqa_g";
const ADMIN_ID = 7798127593;
